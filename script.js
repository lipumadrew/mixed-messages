...
const dictionary = {
    ...
    person: ["mother", "father", "sister", "brother", "grandma", "aunt", "uncle", "grandpa", "son", "daughter", "teacher", "student", "college student", "doctor", "police officer", "software engineer", "trick-or-treater", "violin teacher", "ghost", "witch", "zombie", "vampie", "werewolf"],
    ...
    verbed: ["ate", "slept", "ran", "walked", "cried", "laughed", "haunted", "casted a spell", "cackleed", "did a ritual"],
    verbing: ["eating", "sleepig", "running", "walking", "crying", "laughing", "haunting", "casting a spell", "cackling", "doing a ritual"],
